      ...
      <div className="flex-1 xl:flex-none flex justify-end xl:justify-start gap-[30px] items-center mr-[10px] md:mr-[20px] xl:mr-0">
        ...
        {userDetails.uid ? (
          ...
          <button
            ...
            type="button"
            className="mx-[10px] sm:mx-0 max-w-sm text-white w-full  bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
          >
